...
public class Person {	
	...
	public String toString() {
		if(email==null) {
			return "PersonCode = "+ personCode  + ", FirstName = " + firstName + ", LastName "+ lastName + " : " + address ;
		}
		else 
			return  "PersonCode = "+ personCode  + ", FirstName = " + firstName + ", LastName = "+ lastName + " : " + address + " : " + Arrays.toString(email) ;
